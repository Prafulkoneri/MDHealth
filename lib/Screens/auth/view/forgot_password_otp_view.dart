...
import 'package:md_health/Screens/auth/view/change_password_view.dart';
...
class ForgotPasswordOtpView extends StatefulWidget {
  ...
  const ForgotPasswordOtpView({super.key, required this.verificationId});

  @override
  State<ForgotPasswordOtpView> createState() =>
      _ForgotPasswordOtpViewState(verificationId);
}

class _ForgotPasswordOtpViewState extends State<ForgotPasswordOtpView> {
  final String verificationId;
  _ForgotPasswordOtpViewState(this.verificationId);
