...
class SelectAddressView extends StatefulWidget {
  ...
  final String? id;
  const SelectAddressView({super.key, this.addressID, this.id});
                                ...
                                children: [
                                  PrimaryCheckBox(
                                    ...
                                    onChanged: (value) async {
                                      print(element?.id);
                                      print("Checkbox toggled");
                                      read.selectAddresBox(
                                          context, index, element?.id);
                                      read.getContractAndForms(context);
                                      // read.cartDetailsView(
                                      //     context, watch.selectAddressID);
                                      print(watch
                                          .selectAddressIndex); // Debugging line to check selected index
