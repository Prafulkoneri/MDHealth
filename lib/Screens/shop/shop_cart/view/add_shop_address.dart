...
class ShopNewAddressView extends StatefulWidget {
  final String? addressID;
  final String? id;
  const ShopNewAddressView({super.key, this.addressID, this.id});

  @override
  State<ShopNewAddressView> createState() => _ShopNewAddressViewState();
}

class _ShopNewAddressViewState extends State<ShopNewAddressView> {
  @override
  void initState() {
          ...
          children: [
            ...
            Padding(
              ...
              child: PrimaryCTextFormField(
                ...
                // lengthLimitingTextInputFormatter: LengthLimitingTextInputFormatter(6),
                // allowCommasAndDotsAndSpaces: false,
                // allowOnlyDigits: false,
              ),
            ),
