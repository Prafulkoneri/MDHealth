...
import 'package:md_health/Screens/shop/shop_product_list/view/shop_filtter_search_view.dart';
...
class ShopProductListView extends StatefulWidget {
  ...
  @override
  State<ShopProductListView> createState() => _ShopProductListViewState();
}

class _ShopProductListViewState extends State<ShopProductListView> {
  @override
  void initState() {
    print("pppp");
      ...
      content: watch.isLoading
          ...
          : Column(
              children: [
                ...
                watch.products?.isNotEmpty == false
                    ? Column(
                        children: [
                          ...
                          const Center(
                              child: Image(
                                  image: AssetImage(
                                      'assets/images/No_Shop_Product_Found.png'))),
                        ],
                      )
                    : Container(
                        ...
                        child: GridView.builder(
                          ...
                          itemCount: watch.products?.length ?? 0,
                          gridDelegate:
                          ...
                          itemBuilder: (context, index) {
                            final element = watch.products?[index];
