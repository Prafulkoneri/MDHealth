...
class CustomSelectBoxtype extends StatefulWidget {
  ...
  @override
  State<CustomSelectBoxtype> createState() => _CustomSelectBoxtypeState();
}

class _CustomSelectBoxtypeState extends State<CustomSelectBoxtype> {
  @override
