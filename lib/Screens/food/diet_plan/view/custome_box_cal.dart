...
class CustomSelectBoxtCalories extends StatefulWidget {
  ...
  const CustomSelectBoxtCalories(
      {super.key,
      required this.list,
      this.onTap,
      this.displayButton,
  ...
  @override
  State<CustomSelectBoxtCalories> createState() =>
      _CustomSelectBoxtCaloriesState();
}

class _CustomSelectBoxtCaloriesState extends State<CustomSelectBoxtCalories> {
  @override
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return GestureDetector(
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  children: [
                                    watch.selectedTextIndexcalories == index
                                        ? Container(
                                            height: 22.h,
                                            width: 22.w,
                                            alignment: Alignment.center,
