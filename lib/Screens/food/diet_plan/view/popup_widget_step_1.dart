...
class PopupDialogWidgetStepOne extends StatefulWidget {
  ...
  @override
  State<PopupDialogWidgetStepOne> createState() =>
      _PopupDialogWidgetStepOneState();
}

class _PopupDialogWidgetStepOneState extends State<PopupDialogWidgetStepOne> {
  @override
  Widget build(BuildContext context) {
    debugPrint('helooooooooooooooooooo from meal popup wifdge');
    return Scaffold(
              ...
              child: Container(
                ...
                child: ClipRRect(
                  ...
                  child: SizedBox.fromSize(
                    ...
                    //     10), // Image radius
                    child: const Image(
                        image: AssetImage("assets/images/green_pop_up.png")),
                  ),
                ),
                // child: Image.asset(
