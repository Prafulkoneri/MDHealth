...
class VendorProductFoodListView extends StatefulWidget {
  final String? vendorId;
  // final String? calories;
  // final String? subscriptionType;
  // final String? foodPackageId;
  const VendorProductFoodListView({
    super.key,
  ...
  @override
  State<VendorProductFoodListView> createState() =>
      _NewMostallProviderListState();
}

class _NewMostallProviderListState extends State<VendorProductFoodListView>
  ...
  void initState() {
    SchedulerBinding.instance.addPostFrameCallback((timeStamp) {
      context.read<VendorFoodController>().initState(
            context,
            widget.vendorId,
          );
    });
  ...
  Widget build(BuildContext context) {
    final read = context.read<VendorFoodController>();
    final watch = context.watch<VendorFoodController>();
    return BaseScreen(
      onWillPop: () async {
        Navigator.push(
          context,
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                  ...
                  child: watch.vendorfoodPackagesSearch?.isNotEmpty == true
                      ? ListView.builder(
                          shrinkWrap: true,
                          physics: const NeverScrollableScrollPhysics(),
                          itemCount:
                              watch.vendorfoodPackagesSearch?.length ?? 0,
                          itemBuilder: (context, index) {
                            final element =
                                watch.vendorfoodPackagesSearch?[index];
                            print(element?.image);
                            return Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
