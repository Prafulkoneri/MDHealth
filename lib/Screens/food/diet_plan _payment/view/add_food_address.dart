...
class FoodNewAddressView extends StatefulWidget {
  final String? addressID;
  final String? id;
  const FoodNewAddressView({super.key, this.addressID, this.id});

  @override
  State<FoodNewAddressView> createState() => _FoodNewAddressViewState();
}

class _FoodNewAddressViewState extends State<FoodNewAddressView> {
  @override
  void initState() {
    SchedulerBinding.instance.addPostFrameCallback((_) {
      context
          .read<DietPlanPaymertController>()
