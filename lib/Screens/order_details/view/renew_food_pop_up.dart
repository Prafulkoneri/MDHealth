...
class RenewPopupDialogWidgetStepTwo extends StatefulWidget {
  ...
  const RenewPopupDialogWidgetStepTwo({
    super.key,
    required this.onTap,
  ...
  @override
  State<RenewPopupDialogWidgetStepTwo> createState() =>
      _PopupDialogWidgetStepTwoState();
}

class _PopupDialogWidgetStepTwoState
    extends State<RenewPopupDialogWidgetStepTwo>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((timeStamp) {
      context.read<DietPlanviewController>().initState(context, "", "", "",
          widget.foodPackageId, '', '', widget.id, widget.type);
    });
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      padding: EdgeInsets.only(
                          bottom: 20.w, right: 10.w, left: 10.w),
                      child: Column(
                        children: [
                          SizedBox(
                            height: 80.h,
                          ...
                          Container(
                            ...
                            padding: EdgeInsets.only(bottom: 15.w, left: 30.w),
                            child: Text(
                              'Meals',
                              style: TextStyle(
                                fontFamily: 'Campton',
                                ...
                                Navigator.push(
                                  ...
                                  SlidePageRoute(
                                    page: PaymentDetailsViewDiet(
                                      ...
                                      type: widget.type,
                                      subscriptionType: watch.whoPurhasedata
                                                  ?.subscriptionType?[
