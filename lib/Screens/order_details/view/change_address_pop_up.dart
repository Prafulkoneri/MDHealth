...
class ChnageAddressPopUpView extends StatefulWidget {
  final String? orderId;
  const ChnageAddressPopUpView({
    super.key,
    required this.orderId,
  });

  @override
  State<ChnageAddressPopUpView> createState() => _ChnageAddressPopUpViewState();
}

class _ChnageAddressPopUpViewState extends State<ChnageAddressPopUpView> {
                    ...
                    Stack(
                      children: [
                        ...
                        Positioned(
                          ...
                          // left: 0,
                          child:
                              SvgPicture.asset("assets/icons/location_01.svg"),
                          width: 40.w,
                          height: 40.w,
                        ),
                        Positioned(
