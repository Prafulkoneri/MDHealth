...
class CustomSelectBoxtypePopuP extends StatefulWidget {
  ...
  const CustomSelectBoxtypePopuP(
      {super.key,
      required this.list,
      this.onTap,
      this.displayButton,
  ...
  @override
  State<CustomSelectBoxtypePopuP> createState() =>
      _CustomSelectBoxtypePopuPState();
}

class _CustomSelectBoxtypePopuPState extends State<CustomSelectBoxtypePopuP> {
  @override
  Widget build(BuildContext context) {
    final read = context.read<RenewFoodPopUpController>();
    final watch = context.watch<RenewFoodPopUpController>();
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return GestureDetector(
                              onTap: () {
                                read.setSelectedTexttypes(
                                    context, widget.list[index], index);
                                debugPrint(
                                    '///////////${widget.list[index]}/////////');
                              },
                              child: Padding(
                                ...
                                child: Row(
                                  children: [
                                    watch.selectedTextIndextype == index
                                        ? Container(
                                            height: 22.h,
                                            width: 22.w,
                                            alignment: Alignment.center,
