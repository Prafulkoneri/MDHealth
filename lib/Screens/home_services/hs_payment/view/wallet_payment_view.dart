...
class HsMyWalletScreenView extends StatefulWidget {
  ...
  @override
  State<HsMyWalletScreenView> createState() => _HsMyWalletScreenViewState();
}

class _HsMyWalletScreenViewState extends State<HsMyWalletScreenView> {
  // @override
  // void initState() {
        ...
        child: CustomAppBar(
          ...
          onBackPressed: () {
            Navigator.pushReplacement(
                context,
                MaterialPageRoute(
                    builder: (context) => HSPurchaseDetailsView(
