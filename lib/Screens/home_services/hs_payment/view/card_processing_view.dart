...
class HsCardPaymentCompletedView extends StatefulWidget {
  final String? PackageId;
  const HsCardPaymentCompletedView({super.key, this.PackageId});

  @override
  State<HsCardPaymentCompletedView> createState() =>
      _HsCardPaymentCompletedViewState();
}

class _HsCardPaymentCompletedViewState
    extends State<HsCardPaymentCompletedView> {
  @override
            ...
            Row(
              ...
              children: [
                RichText(
                  ...
                  text: TextSpan(
                    text: 'You can visit the packages page to view your ',
                    style: TextStyle(
                        fontFamily: 'Campton',
                        color: Colors.black,
                        fontSize: 12.sp,
                    ...
                    children: <TextSpan>[
                      ...
                      TextSpan(
                        text:
                            ',\n        or you can request packages by visiting the\n           ',
                        style: TextStyle(
                            fontFamily: 'Campton',
