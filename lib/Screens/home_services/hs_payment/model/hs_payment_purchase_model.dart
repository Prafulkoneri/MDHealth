...
class LastHsPurchaseDetailsRequestModel {
  String? salePrice;
  String? percentage;
  String? price;
  String? purchaseType;
...
class HsLastPurchaseDetailsResponseModel {
  ...
  HsLastPurchaseDetailsResponseModel.fromJson(Map<String, dynamic> json) {
    status = json["status"];
