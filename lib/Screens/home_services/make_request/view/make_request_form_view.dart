...
class HomeServicesMakeRequestView extends StatefulWidget {
  const HomeServicesMakeRequestView({super.key});

  @override
  State<HomeServicesMakeRequestView> createState() =>
      _HomeServicesMakeRequestViewState();
}

class _HomeServicesMakeRequestViewState
    extends State<HomeServicesMakeRequestView> {
  @override
  void initState() {
    SchedulerBinding.instance.addPostFrameCallback((_) {
      context.read<HomeSerivesMakeRequestController>().initState(context);
    });
  }

  @override
  Widget build(BuildContext context) {
    final read = context.read<HomeSerivesMakeRequestController>();
    final watch = context.watch<HomeSerivesMakeRequestController>();
    return BaseScreen(
      onWillPop: () async {
        Navigator.pushReplacement(
          ...
          // MaterialPageRoute(
          //     builder: (context) => HomeServicesMakeRequestView())
        );
        return false;
      },
        ...
        return Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                "Fill the form & get your desired home service plan.",
            ...
            Padding(
              padding: EdgeInsets.only(left: 20.0.w, right: 20.w),
              child: PrimaryInformationTextFormField(
                controller: watch.homeServicesController,
                // color: Colors.red,
                // width: 48.w,
                titleHeader: "Home Service Name",
                hintText: "Home Service Name",
              ),
            ),
            SizedBox(
              height: 20.h,
            ...
            Padding(
              padding: EdgeInsets.only(left: 20.0.w, right: 20.w),
              child: PrimaryInformationTextFormField(
                titleHeader: "When do you need the home service?",
                controller: watch.whydoyouneeedHSController,
                hintText: "When do you need the home service?",
              ),
            ),
            SizedBox(
              height: 20.h,
              ...
              child: PrimaryButton(
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        "Upload Your Home Service Image ",
                        style: TextStyle(
                            fontFamily: 'Campton',
            ...
            Padding(
              ...
              child: PrimaryButton(
                ...
                onTap: () {
                  read.homeServicesFillMakeRequest(context);
                },
                child: Text(
                  "Submit",
                  style: TextStyle(
