...
class CustomSelectBoxHs extends StatefulWidget {
  ...
  @override
  State<CustomSelectBoxHs> createState() => _CustomSelectBoxHsState();
}

class _CustomSelectBoxHsState extends State<CustomSelectBoxHs> {
  @override
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return GestureDetector(
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  children: [
                                    watch.selectedTextIndexcity == index
                                        ? Container(
                                            height: 22.h,
                                            width: 22.w,
                                            alignment: Alignment.center,
