...
class SelectedSeviecPopUp extends StatefulWidget {
  ...
  @override
  State<SelectedSeviecPopUp> createState() => _SelectedSeviecPopUpState();
}

class _SelectedSeviecPopUpState extends State<SelectedSeviecPopUp> {
  @override
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return GestureDetector(
                              onTap: () async {
                                ...
                                debugPrint(
                                    '////DFGFSD///////${widget.list[index]}////DSFDSD/////');
                                await read.cityPackageHs(
                                    context, watch.selectedText);
                              },
                              child: Padding(
