...
class FoodFavListView extends StatefulWidget {
  final String? packageId;
  const FoodFavListView({super.key, required this.packageId});

  @override
  State<FoodFavListView> createState() => _FoodFavListViewState();
}

class _FoodFavListViewState extends State<FoodFavListView> {
  @override
  void initState() {
        ...
        content: Column(
          children: [
            Container(
                ...
                child: watch.foodFavListdata?.isNotEmpty == true
                    ? ListView.builder(
                        // padding: EdgeInsets.zero,
                        shrinkWrap: true,
                        physics: const NeverScrollableScrollPhysics(),
                        itemCount: watch.foodFavListdata?.length ?? 0,
                        itemBuilder: (context, index) {
                          final element = watch.foodFavListdata?[index];
                          return Container(
                                            ...
                                            children: [
                                              ...
                                              PrimaryButton(
                                                  ...
                                                  onTap: () {
                                                    print(
                                                        element?.id.toString());
                                                    // return;removeFoodToFav(context, foodID)
                                                    read.removeFoodToFav(
                                                        context,
                                                        element?.id.toString());
                                                    showDialog(
                                                        context: context,
