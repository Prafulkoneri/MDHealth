...
class ShopFavListView extends StatefulWidget {
  // final String? packageId;
  const ShopFavListView({super.key});

  @override
  State<ShopFavListView> createState() => _ShopFavListViewState();
}

class _ShopFavListViewState extends State<ShopFavListView> {
  @override
  void initState() {
        ...
        content: Column(
          children: [
            Container(
                ...
                child: watch.shopFavListDatas?.isNotEmpty == true
                    ? ListView.builder(
                        // padding: EdgeInsets.zero,
                        shrinkWrap: true,
                        physics: const NeverScrollableScrollPhysics(),
                        itemCount: watch.shopFavListDatas?.length ?? 0,
                        itemBuilder: (context, index) {
                          final element = watch.shopFavListDatas?[index];
                          return Container(
