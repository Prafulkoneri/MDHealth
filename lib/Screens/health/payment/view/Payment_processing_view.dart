...
import 'package:md_health/Screens/health/payment/view/payment_completed_view.dart';
...
class PaymentProcessingView extends StatefulWidget {
  ...
  const PaymentProcessingView({super.key, required this.purchesId});
  ...
  void initState() {
    ...
    Future.delayed(const Duration(seconds: 2), () {
      ...
      Navigator.of(context).pushReplacement(MaterialPageRoute(
        builder: (context) => PaymentCompletedView(),
      ));
    });
  }
