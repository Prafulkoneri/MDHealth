...
class CustomSelectBoxTreatment extends StatefulWidget {
  ...
  const CustomSelectBoxTreatment(
      {super.key,
      required this.list,
      this.onTap,
      this.displayButton,
  ...
  @override
  State<CustomSelectBoxTreatment> createState() =>
      _CustomSelectBoxTreatmentState();
}

class _CustomSelectBoxTreatmentState extends State<CustomSelectBoxTreatment> {
  @override
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return GestureDetector(
                              onTap: () {
                                read.setSelectedText1(
                                    widget.list[index], index);
                                debugPrint(
                                    '///////////${widget.list[index]}/////////');
                                read.NewCitiestratment(
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  children: [
                                    watch.selectedTextIndex1 == index
                                        ? Container(
                                            height: 22.h,
                                            width: 22.w,
                                            alignment: Alignment.center,
