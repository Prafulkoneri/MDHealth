...
class CustomSelectBoxSort extends StatefulWidget {
  ...
  @override
  State<CustomSelectBoxSort> createState() => _CustomSelectBoxSortState();
}

class _CustomSelectBoxSortState extends State<CustomSelectBoxSort> {
  @override
